        ...
        <aside class="main-sidebar hidden-print ">
            <section class="sidebar" id="sidebar-scroll">
                ...
                <li class="treeview"><a class="waves-effect waves-dark">
                    ...
                    <li class="active treeview"><a class="waves-effect waves-dark" href="prediccion.php"><i class="icon-speedometer text-success-color"></i><span>Predicción</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 p-0">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">Lista de ingresos</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <?php
                      ...
                      $mes_actual = date("n", strtotime(date("Y-m-d").'+1 month'));
                      $mes_actual = $mes[$mes_actual-1];
                    ?>
                    <div class="col-sm-4" style="margin-top: 0px;">
                       <div class="card" style="padding: 10px; text-align: center">
                         <h1>Ganancias para <?php echo $mes_actual ?></h1>
                         <p>Arroz</p>
                         <h3 style="color: green" id="pa">$0</h3>
                       </div>
                    </div>
                    ...
                    <div class="col-sm-4" style="margin-top: 0px;">
                       <div class="card" style="padding: 10px; text-align: center">
                         <h1>Ganancias para <?php echo $mes_actual ?></h1>
                         <p>Maíz</p>
                         <h3 style="color: green" id="pm">$0</h3>
                       </div>
                    </div>
                    <div class="col-sm-4" style="margin-top: 0px;">
                       <div class="card" style="padding: 10px; text-align: center">
                         <h1>Ganacias totales</h1>
                         <p>Arroz / Maíz</p>
                         <h3 style="color: green" id="pt">$0</h3>
                       </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        ...
                        <div class="card ">
                            <div class="card-header">
                              <h5>Ingresos mensuales de arroz</h5>
                            ...
                            <div class="card-block ">
                                ...
                                <div class="col-sm-12 table-responsive">
                                    <table id="myTable" class="table">
                                        ...
                                        <?php  
                                            $gananciasa = [];
                                            $consulta1="SELECT DISTINCT DATE_FORMAT(fecha,'%Y-%c') as mes FROM factura_venta;";
                                            ...
                                            while ($valores = mysqli_fetch_array($resultado1)) { 
                                                ...
                                                $fecha = $valores['mes'];
                                                //echo date('Y-m', strtotime($fecha));
                                                //get month 
                                                $mes = date("m", strtotime($fecha));
                                                $anio = date("Y", strtotime($fecha));

                                                $sqlmonth = "SELECT fac.fecha, proc.cantidad_procesada as cantidad, fac.total as ingreso, prod.nombre as producto
                                                    FROM detalle_venta dv
                                                    INNER JOIN factura_venta fac ON dv.cod_venta = fac.cod_venta
                                                    JOIN proceso_producto proc ON proc.cod_proceso = dv.cod_proceso
                                                    JOIN actividad ON actividad.cod_actividad = proc.cod_actividad
                                                    JOIN producto prod ON prod.cod_producto = actividad.cod_producto WHERE MONTH(fecha) = '$mes' AND YEAR(fecha) = '$anio' AND prod.cod_producto = 1;";

                                                $resultmonth = mysqli_query($conexion,$sqlmonth);
                                                  
                                                  $v3 = 0;
                                                  $v4 = 0;

                                                  while($valoresmonth = mysqli_fetch_array($resultmonth)){

                                                    $v1 = date("Y / F", strtotime($valoresmonth['fecha']));
                                                    $v2 = $valoresmonth['producto'];
                                                    $v3 += intval($valoresmonth['cantidad']);
                                                    $v4 += intval($valoresmonth['ingreso']);
                                                    
                                                  }

                                                  if(mysqli_num_rows($resultmonth) > 0){
                                                    echo '<tr>
                                                      <td>'.date("Y/F", strtotime($fecha)).'</td>
                                                      <td>'.$v2.'</td>
                                                      <td>'.$v3.' Q</td>                                                  
                                                      <td>$'.$v4.'</td>
                                                    </tr>';
                                                    //append v4 to array
                                                    if($anio == date('Y')){
                                                      array_push($gananciasa, floatval($v4));
                                                    }
                                                  }
                                            }
                                            ...
                                            if(empty($gananciasa)){
                                              ...
                                              $intervaloMeses = count($gananciasa);
                                              $periodoAnual = round(12/$intervaloMeses, 2);
                                              $totalGanancias = array_sum($gananciasa)/$intervaloMeses;
                                              $predicciona = $totalGanancias * $periodoAnual;
                                            }

                                            $fmt = new NumberFormatter("en_US",  NumberFormatter::CURRENCY) ;
                                            $usda = $fmt->formatCurrency($predicciona, "USD");


                                            
                                            echo "<script>
                                                document.getElementById('pa').innerHTML = '".$usda."';
                                            </script>";
                    ...
                    <div class="col-sm-12 ">
                        ...
                        <div class="card ">
                            <div class="card-header">
                              <h5>Ingresos mensuales de maíz</h5>                              
                            </div>
                            <div class="card-block ">
                                        ...
                                        <?php  
                                            ...
                                            while ($valores = mysqli_fetch_array($resultado1)) { 
                                                ...
                                                $sqlmonth = "SELECT fac.fecha, proc.cantidad_procesada as cantidad, fac.total as ingreso, prod.nombre as producto
                                                    ...
                                                    JOIN proceso_producto proc ON proc.cod_proceso = dv.cod_proceso
                                                    JOIN actividad ON actividad.cod_actividad = proc.cod_actividad
                                                    JOIN producto prod ON prod.cod_producto = actividad.cod_producto WHERE MONTH(fecha) = '$mes' AND YEAR(fecha) = '$anio' AND prod.cod_producto = 2;";
                                                ...
                                                $resultmonth = mysqli_query($conexion,$sqlmonth);
                                                  ...
                                                  if(mysqli_num_rows($resultmonth) > 0){
                                                    ...
                                                    //append v4 to array
                                                    array_push($gananciasm, floatval($v4));
                                                  }
                                            }		
                                            ...
                                            if(empty($gananciasm)){
                                              ...
                                              $intervaloMeses2 = count($gananciasm);
                                              $periodoAnual2 = round(12/$intervaloMeses2, 2);
                                              $totalGanancias2 = array_sum($gananciasm)/$intervaloMeses2;
                                              $prediccionm = $totalGanancias2 * $periodoAnual2;
                                            }

                                            $prediccionTotal = $predicciona + $prediccionm;
                                            
                                            $usdm = $fmt->formatCurrency($prediccionm, "USD");
                                            $usdt = $fmt->formatCurrency($prediccionTotal, "USD");

                                            echo "<script>
                                                document.getElementById('pm').innerHTML = '$usdm';
                                                document.getElementById('pt').innerHTML = '$usdt';
                                            </script>";
