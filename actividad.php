            ...
            <section class="sidebar" id="sidebar-scroll">
                ...
                <li class="treeview"><a class="waves-effect waves-dark">
                    ...
                    <?php if($_SESSION['rol'] == 4 || $_SESSION['rol'] == 1){ ?>
                      <li class="active treeview"><a class="waves-effect waves-dark" href="actividad.php"><i class="ti-layout-column3 text-primary-color"></i><span>Actividad</span></a></li>
                    <?php } ?>
                    <?php if($_SESSION['rol'] != 4){ ?>
                    ...
                    <div class="col-sm-12 p-0">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">Lista de actividades</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 ">
                        ...
                        <div class="card ">
                            <div class="card-header">
                              <h5>Orden de estados</h5>
                              <div style='font-size: 10px; border-radius: 20px' class='btn bg-primary'>Húmedo</div>
                              <i class="ti-angle-right"></i>
                              <div style='font-size: 10px; border-radius: 20px' class='btn bg-success'>Seco</div>
                              <i class="ti-angle-right"></i>
                              <div style='font-size: 10px; border-radius: 20px' class='btn bg-warning'>Pelado</div>
                            </div>
                                        ...
                                        <?php  
                                            ...
                                            while ($valores = mysqli_fetch_array($resultado1)) {
                                                ...
                                                echo '<tr>
                                                    ...
                                                    echo '
                                                    <td>'.$valores['fecha'].'</td>
                                                    <td>'.date("Y-m-d", strtotime($valores['fecha']."+ 2 days")).'</td>
                                                    <td>';

                                                    if($valores['Actividad']=='Seco' && $valores['Producto']=='MAIZ'){
                                                      echo "<button disabled title='Este es el último estado disponible' class='btn btn-secondary'>Siguiente estado</button>";
                                                    }else{
                                                      if($valores['Actividad']!= "Pelado"){
                                                        echo "<a href='estadoactividad.php?id=".$valores['compraid']."&aid=".$valores['aid']."&prod=".$valores['Producto']."' class='btn bg-success'>Siguiente estado</a>";
                                                    }else{
                                                        echo "<button disabled title='Este es el último estado disponible' class='btn btn-secondary'>Siguiente estado</button>";
                                                    }
                                                    }
