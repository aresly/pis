    ...
    <div class="wrapper">
        ...
        <section class="sidebar" id="sidebar-scroll">
                ...
                <li class="treeview"><a class="waves-effect waves-dark">
                    ...
                    <?php } ?>
                    <?php if( $_SESSION['rol'] == 3 || $_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){ ?>
                      <li class="treeview active"><a class="waves-effect waves-dark" href="providers.php"><i class="ti-truck text-danger-color"></i><span>Proveedores</span></a></li>
                    <?php } ?>
                    <?php if($_SESSION['rol'] == 3 || $_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){ ?>
                            ...
                            <div class="card-block ">
                                ...
                                <div class="tab-content ">
                                    <div class="tab-pane fade in active " role="tabpanel" aria-labelledby="tabNewAdmin" id="tabNewAdmin">
                                        <div class="row boot-ui">
                                            <div class="col-sm-12 col-xs-12 waves-effect waves-light">
                                                <div class="grid-material bg-success">NUEVO PROVEEDOR</div>
                                            </div>
                                        </div>
                                        <form action="registrocliente.php" method="post">
                                            <div class="col-sm-6">
                                                <h5 class="text-condensedLight">Datos Proveedores</h5>
                                                ...
                                                <div class="text-center">
                                                    <button  class="btn btn-success btn-icon waves-effect waves-light" id="btn-addAdmin" data-toggle="tooltip" data-placement="top" title="Agregar Proveedor">
                                    ...
                                    <div class="tab-pane fade col-md-12" role="tabpanel" aria-labelledby="profile-tab" id="tabListAdmin">
                                            <div class="row boot-ui">
                                                <div class="col-sm-12 col-xs-12 waves-effect waves-light">
                                                    <div class="grid-material bg-success">LISTA DE PROVEEDORES</div>
                                                </div>
                                            </div>
                                            <?php  
                                                $consulta1="SELECT nombre, apellido, cedula,telefono, correo FROM proveedor";
